...
/*        CGMutablePathRef path = CGPathCreateMutable();
        ...
        CGPathMoveToPoint(path2, NULL, old_x2d, old_y2d);
        CGPathAddLineToPoint(path2, NULL, x2d, y2d);
        CGContextAddPath(context, path2);
        
        CGContextSetLineWidth(context, z2d);
...
/*        CGMutablePathRef leadPointPath = CGPathCreateMutable();
        ...
        CGContextSetLineWidth(context, 0.5);
        CGContextSetFillColorWithColor(context, _leadPointColor.CGColor);
        CGPathAddArc(leadPointPath, NULL, xd, yd, 10.0, 0, radians(360), 0);
        CGContextAddPath(context, leadPointPath);
        CGContextFillPath(context);
        
        
        CGContextSetStrokeColorWithColor(context, _leadStrokeColor.CGColor);
        CGContextAddPath(context, leadPointPath);
        CGContextStrokePath(context);
